<?php 
require_once 'models/bagels.model.php';
...
foreach($rows as $row): 
    ...
    <tr>
        ...
        <td class=""><?= $row['prix_article'] ?> €</td> 
        <td><a href="../admin/modifier_article/<?= $row['nom_article']?>"><i class="fas fa-edit text-primary"></i></a></td>
        <td><a href="models/remove.model.php?/<?= $row['nom_article']?>"><i class="fas fa-trash-alt text-danger"></i></a></td>
    </tr> 
<?php  endforeach; ?>
